...
button:active {
  box-shadow: inset 0px 1px 6px #0007;
}
...
.led:after {
  ...
  box-shadow: inset 0px 3px 0px 0px #fff5
}

.led.red:checked:after {
  background-color: #d00;
  box-shadow: inset 0px 3px #fff7, 0px 0px 10px 1px #f00b;
}

.led.green:checked:after {
  background-color: #3c0;
  box-shadow: inset 0px 3px #fff7, 0px 0px 10px 1px #4d08;
}
...
input[type=range] {
  ...
  cursor: pointer;
  padding: 0px;
  background-image: linear-gradient(#37a93c, #37a93c);
}
...
.check_c>input:checked+span::before {
  border-color: #4CAF50;
  background-color: #4CAF50;
  background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'%3e%3cpath d='m12.82,3l-6.6,6.6l-3,-3-1.9,1.9l5,5.00687l8.5,-8.5-1.9,-1.9z' fill='%23fff'/%3e%3c/svg%3e");
}

.check_c>input:disabled+span::before {
  background-color: #e9ecef;
}

.check_c>input:hover+span::before {
...
#blockBack input[type='range'] {
  background: #13161a;
  background-repeat: no-repeat;
}
#blockBack input:checked + .slider {
  background-color: #37a93c;
}
body {
  font-family: Verdana;
...
.led.red:checked:after {
  background-color: #d00;
  box-shadow: inset 0px 3px 0px 0px #fff7, 0px 0px 10px 4px #f00b;
}
.led.green:checked:after {
  background-color: #3c0;
  box-shadow: inset 0px 3px 0px 0px #fff7, 0px 0px 10px 4px #4d08;
}
.ledn {
  margin: 9px 10px;
}
.ledn:after {
  ...
  display: inline-block;
  background-color: #d00;
  box-shadow: inset 0px 3px 0px 0px #fff7, 0px 0px 10px 2px #f00;
}
.ledn:checked:after {
  background-color: #3c0;
  box-shadow: inset 0px 3px 0px 0px #fff7, 0px 0px 10px 2px #4d0;
}
.miniButton {
  min-height: 40px;
  height: auto !important;
